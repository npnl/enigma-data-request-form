...
const TimepointSelection = () => {
    ...
    const timepointSelection = useSelector((state: RootState) => state.metrics.timepoint);
    ...
    return (
        <FormControl fullWidth className="mt-4">
            ...
            >
                <MenuItem value="baseline">Cross-sectional (Subjects with baseline timepoint only)</MenuItem>
                <MenuItem value="multi">Longitudinal (Subjects with multiple timepoints)</MenuItem>
            </Select>
        </FormControl>
    );
};
