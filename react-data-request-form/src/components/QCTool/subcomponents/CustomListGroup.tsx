                                    ...
                                    {typeof val === 'string' && val.includes('<<') && val.includes('>>') ? (
                                        <>
                                            <input
                                                ...
                                                onChange={(e) => handleChange(`${getKey(val)}`, e.target.value)}
                                                className={`form-control ${isError(val) ? 'border border-warning' : ''}`}
                                            />
                                            {isError(val) && (
                                                <OverlayTrigger
                                                    placement="top"
                                                ...
                                                >
                                                    <span className="ml-2 text-warning" role="img" aria-label="warning">
                                                        ⚠️
                                                    </span>
                                                </OverlayTrigger>
                                            )}
