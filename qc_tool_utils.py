...
medical_history = {
    ...
    'value': [
        ...
        {
            "Condition": "Clinical Obesity (BMI > 29.9)",
            "Yes/No": "<<OBESITY>>"
        },
        {
            "Condition": "Smoking",
        ...
        },
        {
            ...
            "Yes/No": "<<HYPERLIPIDEMIA>>"
        },
        {
            "Condition": "Renal/Cardiac Failure",
            "Yes/No": "<<RENALCARDIAC_FAILURE>>"
        },
        {
        ...
        {
            "Condition": "Other Neurological Disease",
            "Yes/No": "<<OTHER_NEURO>>"
        },
        {
            "Condition": "Other",
    ...
    'value': [
        {
            ...
            "Stroke Location": ["<<STROKELOCATION_CORTICAL>>", "<<STROKELOCATION_SUBCORTICAL>>", "<<STROKELOCATION_MIDBRAIN>>", "<<STROKELOCATION_BRAINSTEM>>", "<<STROKELOCATION_OTHER>>"]
        }
    ]
}
...
handedness = {
    ...
    'value': [
        {
            "Handedness (choose one):": "<<EDINBURGH_HANDEDNESS>>"
        }
    ]
}
...
edinburgh_handedness_score = {
    ...
    'value': [
        {
            "Edinburgh Handedness Score (Range: -100 +100)": "<<EDINBURGH_TOTAL>>"
        }
    ]
}
...
safe = {
    ...
    'value': [
        {
            "Side": "Right",
            "Deltoid": "<<SAFE_DELTOID_R>>",
            "FE": "<<SAFE_FE_R>>"
        },
        {
            "Side": "Left",
            "Deltoid": "<<SAFE_DELTOID_L>>",
            "FE": "<<SAFE_FE_L>>"
        }
    ]
}
...
total_safe_score = {
    ...
    'value': [
        {
            "Right SAFE Score": "<<SAFE_R>>",
            "Left SAFE Score": "<<SAFE_L>>"
        }
    ]
}
...
fugl_total = {
    ...
    'value': [
        {
            'Right Total': '<<FMUE_TOTAL_R_SUM>>',
            'Left Total': '<<FMUE_TOTAL_L_SUM>>'
        }
    ]
}
...
sis = {
    ...
    'ordering': {
        0: "In the past 2 weeks, how difficult was it to",
        1: "Score"
    },
    'value': [
        {
